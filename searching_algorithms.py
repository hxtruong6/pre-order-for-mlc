...
class search_BOPreOs:
    ...
    def PRE_ORDER_HAM(self):
        pass

    def PRE_ORDER_SUB(self):
        pass


class search_BOParOs:

    def __init__(self, pairwise_probabilistic_predictions, n_labels, n_instances, height):
        self.pairwise_probabilistic_predictions = pairwise_probabilistic_predictions
        self.n_labels = n_labels
        self.n_instances = n_instances
        self.height = height

    def PARTIAL_ORDER_SUB(self):
        indices_vector = {}
        indVec = 0
...
#                    key = "%i_%i_%i" % (i, j, l)
        ...
        for n in range(self.n_instances):
            ...
            hard_prediction_indices, predicted_partial_order = (
                search_BOParOs._reasoning_procedure_PARTIAL_ORDER_SUB(
                    vector,
                    indices_vector,
                    self.n_labels,
                    Gtest,
    ...
    def _encode_parameters_PARTIAL_ORDER_SUB(self, indices_vector, height=None):
...
#                        indVec = indices_vector["%i_%i_%i" % (i, j, l)]
    ...
    def _reasoning_procedure_PARTIAL_ORDER_SUB(
