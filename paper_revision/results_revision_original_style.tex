...
\section{Abstention overview: aggregate trends}\label{sec:abstain_overview}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.95\linewidth]{rf/abstain/f1_pa/aggregate/paired_bars.pdf}
\caption{RF aggregate (f1\_pa): standard-MLC vs.\ with-abstention quality across $\alpha\in\{0.0,0.1,0.2,0.3\}$, averaged over all datasets.}
\label{fig:abstain_overview_rf_f1_pa}
\end{figure}

\begin{figure}[!htbp]
\centering
\includegraphics[width=0.95\linewidth]{rf/abstain/jaccard_pa/aggregate/paired_bars.pdf}
\caption{RF aggregate (jaccard\_pa): standard-MLC vs.\ with-abstention quality across $\alpha\in\{0.0,0.1,0.2,0.3\}$, averaged over all datasets.}
\label{fig:abstain_overview_rf_jaccard_pa}
\end{figure}

\begin{figure}[!htbp]
\centering
\includegraphics[width=0.95\linewidth]{lgbm/abstain/f1_pa/aggregate/paired_bars.pdf}
\caption{LGBM aggregate (f1\_pa): standard-MLC vs.\ with-abstention quality across $\alpha\in\{0.0,0.1,0.2,0.3\}$, averaged over all datasets.}
\label{fig:abstain_overview_lgbm_f1_pa}
\end{figure}

\begin{figure}[!htbp]
\centering
\includegraphics[width=0.95\linewidth]{lgbm/abstain/jaccard_pa/aggregate/paired_bars.pdf}
\caption{LGBM aggregate (jaccard\_pa): standard-MLC vs.\ with-abstention quality across $\alpha\in\{0.0,0.1,0.2,0.3\}$, averaged over all datasets.}
\label{fig:abstain_overview_lgbm_jaccard_pa}
\end{figure}
